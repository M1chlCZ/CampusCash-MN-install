...
FUCK=$(cat $HOME/.CCASH/CampusCash.conf | sed '/addnode/d')
...
FUCK=$(cat $HOME/.CCASH\$1/CampusCash.conf | sed '/addnode/d')
...
FUCK=$(cat $HOME/.CCASH2/CampusCash.conf | sed '/addnode/d')
